##
#  GENERATED by tools/make_uefi_platform.py from
#  suryaPkg/DeviceBuild.py - do not edit by hand.
#
#  Differs from the reference only in the device name.
##
##
...
class CommonPlatform ():
    PackagesSupported = ("gauguinPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('gauguin', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "gauguin", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "gauguinPkg/gauguin.dsc", "Platform Hardcoded")
